...
def main():
    parser = argparse.ArgumentParser(description="Initialize the MySQL schema and load sample data.")
    parser.add_argument(
        "--reset",
        action="store_true",
        help="Drop all tables before recreating them and reloading sample data.",
    )
